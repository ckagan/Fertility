...
SNP_file_name = "QCgeno_noFC_49_cauconly.txt" 
expression_file_name = "Final_GeneExprDetected.7_woFC_cauconly.txt"

#In case of no covariates set the variable covariates_file_name to character() in R ([] in Matlab).

covariates_file_name = character() 
output_file_name = "eQTL_results_cauconly.txt"
output_file_name.cis = "eQTL_results_cis_allpval_QCgeno_cauconly.txt"
